package pl.kalisz.ak.pup.karol.todo;
...
public class DetailActivity extends AppCompatActivity {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (todoTitle.getText().toString().length() > 0
                    ...
                    Toast.makeText(getApplicationContext(), "Dodaj", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void addTodo() {
        ...
        if (id > 0) {
            Toast.makeText(this, "Zaaktualizowano", Toast.LENGTH_SHORT).show();
        } else {
